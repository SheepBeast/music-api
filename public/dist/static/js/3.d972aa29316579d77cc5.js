  ...
  JQ9a: function(t, s, a) {
    ...
    var e = function() {
        var t = this,
          ...
          a = t._self._c || s;
        return t.playlist
          ? a("page", { staticClass: "playlist", attrs: { id: "playlist" } }, [
              a(
                "section",
                ...
                [
                  a("div", {
                    staticClass: "blur-bg",
                    style: {
                      "background-image": "url(" + t.playlist.coverImgUrl + ")"
                    }
                  }),
                  t._v(" "),
                  a(
                        ...
                        t.playlist.creator
                          ? a(
                              ...
                              [
                                a("avatar", [
                                  a("img", {
                                    attrs: { src: t.playlist.creator.avatarUrl }
                                  })
                                ]),
                                t._v(" "),
                                a(
              ...
              t._v(" "),
              t.playlist.tags.length > 0 && t.playlist.description
                ? a(
                    "section",
                    { staticClass: "intro" },
                    [
                      t.playlist.tags.length > 0
                        ? a(
                            ...
                            [
                              t._v("\n      标签：\n      "),
                              t._l(t.playlist.tags, function(s) {
                                return a("span", { key: s }, [t._v(t._s(s))]);
                              })
                            ],
                            2
                          )
                ...
                : t._e(),
              t._v(" "),
              t.playlist.tracks.length > 0
                ? a(
                    "section",
                    [
                      a("h4", { staticClass: "trk-title" }, [t._v("歌曲")]),
                      t._v(" "),
                      a(
                        "list",
                        t._l(t.playlist.tracks, function(s, e) {
                          return a(
                            "list-item",
                            { key: s.id },
                            [
              ...
              t.playlist.comments.length > 0
                ? a(
                    ...
                    { staticClass: "comment" },
                    [
                      a("h4", { staticClass: "cmt-title" }, [t._v("评论")]),
                      t._v(" "),
                      a(
                        "list",
                        t._l(t.playlist.comments, function(s) {
                          return a(
                            "list-item",
                            { key: s.commentId },
                            [
                                ...
                                [
                                  a("list-item-inner", [
                                    ...
                                    a("div", { staticClass: "third-title" }, [
                                      t._v(t._s(s.timeString))
                                    ]),
                                    t._v(" "),
                                    s.translatedBeReplied
                                      ? a(
                                          "div",
                                          { staticClass: "message" },
                                          [
                                      ...
                                      : a("div", {
                                          staticClass: "message",
                                          domProps: {
                                            innerHTML: t._s(s.translatedMessage)
                                          }
                                        })
                                  ])
                                ],
      ...
      l = [],
      i = { render: e, staticRenderFns: l };
    s.a = i;
  }
});
//# sourceMappingURL=3.d972aa29316579d77cc5.js.map
