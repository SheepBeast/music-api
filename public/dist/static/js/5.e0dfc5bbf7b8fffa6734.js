  ...
  pxdF: function(t, s, a) {
    ...
    var e = function() {
        var t = this,
          ...
          a = t._self._c || s;
        return t.artist
          ? a("page", { staticClass: "playlist artist" }, [
              a(
                "div",
                ...
                [
                  ...
                  t._v(" "),
                  a("h4", { staticClass: "f-elpsl-1 ar-name" }, [
                    t._v(t._s(t.artist.name)),
                    t.artist.alias
                      ? a("span", [t._v("（" + t._s(t.artist.alias) + "）")])
                      : t._e()
                  ])
                ],
                1
              ...
              t.hotSongs
                ? a(
                    "section",
                    [
                      a("h4", { staticClass: "trk-title" }, [
                        t._v("热门" + t._s(t.hotSongs.length) + "单曲")
                      ]),
                      t._v(" "),
                      a(
                        "list",
                        t._l(t.hotSongs, function(s, e) {
                          return a(
                            "list-item",
                            { key: s.id },
                            [
...
//# sourceMappingURL=5.e0dfc5bbf7b8fffa6734.js.map
